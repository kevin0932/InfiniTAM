...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
// __global__ void buildListToSwapOut_device_ForceSave(int *neededEntryIDs, int *noNeededEntries, ITMHashSwapState *swapStates,
// 	ITMHashEntry *hashTable, uchar *entriesVisibleType, int noTotalEntries);

// template<class TVoxel>
// __global__ void cleanMemory_device_ForceSave(int *voxelAllocationList, int *noAllocatedVoxelEntries, ITMHashSwapState *swapStates,
// 	ITMHashEntry *hashTable, TVoxel *localVBA, int *neededEntryIDs_local, int noNeededEntries);

// template<class TVoxel>
// __global__ void moveActiveDataToTransferBuffer_device_ForceSave(TVoxel *syncedVoxelBlocks_local, bool *hasSyncedData_local,
...
{
	// std::cout<<"ITMSwappingEngine_CUDA<TVoxel, ITMVoxelBlockHash>::SaveToGlobalMemory"<<std::endl;
...
// template<class TVoxel>
// void ITMSwappingEngine_CUDA<TVoxel, ITMVoxelBlockHash>::ForceSaveToGlobalMemory(ITMScene<TVoxel, ITMVoxelBlockHash> *scene, ITMRenderState *renderState)
// {
// 	// std::cout<<"ITMSwappingEngine_CUDA<TVoxel, ITMVoxelBlockHash>::SaveToGlobalMemory"<<std::endl;
...
// 	uchar *entriesVisibleType = ((ITMRenderState_VH*)renderState)->GetEntriesVisibleType();
// 	// testing
// 	// std::cout<<"entriesVisibleType: "<<entriesVisibleType[0]<<std::endl;
...
// 	// // testing
// 	// std::cout<<"neededEntryIDs_local: "<<neededEntryIDs_local[0]<<std::endl;
// 	// std::cout<<"neededEntryIDs_global: "<<neededEntryIDs_global[0]<<std::endl;
...
// 		// buildListToSwapOut_device << <gridSize, blockSize >> >(neededEntryIDs_local, noNeededEntries_device, swapStates,
// 			// hashTable, entriesVisibleType, noTotalEntries);
// 		buildListToSwapOut_device_ForceSave << <gridSize, blockSize >> >(neededEntryIDs_local, noNeededEntries_device, swapStates,
// 			hashTable, entriesVisibleType, noTotalEntries);			
